...
def cluster_single_chunk(filename,
    ...
    km = KMeans(n_clusters=n_clusters, random_state=0, init="random")
...
def cluster_single_file(filename, text_col_name, output_dir, n_clusters, n_process, batch_size=10000):
    line_count = 0
    with open(filename) as f:
